let page_dashboard = (function() {
    ...
    function initialize(){
        ...
        }, /*settings.ajax_timeouts.FAST*/100000000000000000000);
    }
    ...
    function get_new_orders(){
        main.data_list.ORDERS.forEach(order => {
            ...
            if(typeof array_list.find(main.data_list.APP_TABLE_SECTIONS, table.section_id) !== "undefined") return;
            ...
            if (result.value) {
                set(
                    ...
                    function (data) {
                        ...
                        console.log(data);
                        if(data.status){
                            helper_sweet_alert.success(language.data.ORDER_PRINT, language.data.RECEIPT_SENT_PRINTER)
                        }
                    }
                );
            }
            ...
            self.variable_list.SWIPER = new Swiper(self.id_list.SWIPER, {
                ...
                pagination: {
                    ...
                    renderBullet: function (index, className) {
                        ...
                        let firstDisabled = "";
                        switch (index) {
                            case 0: icon = "home"; break;
                            case 1: icon = "table-of-contents";  firstDisabled="disabled-element"; break;
                            case 2: icon = "cogs"; break;
                            default:break;
                        }
        ...
        get_table_sections: function () {
            ...
            function create_element(){
                ...
                main.data_list.SECTIONS.forEach(section => {
                    ...
                    if(typeof array_list.find(main.data_list.APP_TABLE_SECTIONS, section.id) !== "undefined") return;
        ...
        get_table_sections_for_application: function () {
            ...
            function create_element(){
                ...
                main.data_list.SECTIONS.forEach(section => {
                    ...
                    let checked = "checked";
                    if(typeof array_list.find(main.data_list.APP_TABLE_SECTIONS, section.id) === "undefined") checked = "";
...
`               ;
        ...
        get_tables: function () {
            ...
            function create_element() {
                ...
                let sections = (self.variable_list.SELECTED_SECTION_ID > 0)
                    ? array_list.find_multi(main.data_list.SECTIONS, self.variable_list.SELECTED_SECTION_ID, "id")
                ...
                sections.forEach(section => {
                    ...
                    tables.forEach(table => {
                        ...
                        let table_status = "free-table";
                        let function_buttons = "hidden-and-events-none";
                        if(orders.length > 0){
                            table_status = "filled-table";
                            function_buttons = "";
                        }

                        element += `
                            <div class="e_table col-12 mt-1 p-4 ${table_status} " table-id="${table.id}">
                                <div class="row">
                                    ...
                                    <div class="col-2 text-center pl-1 pr-0">
                                        <button type="button" class="e_main_table_btn btn btn-outline-success btn-sm ${function_buttons} main-page-table-btn" function="move">${language.data.MOVE}</button>
                                    </div>
        ...
        initialize: function () {
            ...
            function set_events(){
                ...
                $(document).on("click", self.class_list.BUTTON_TABLE, function(){
                    ...
                    page_table_detail.variable_list.SELECTED_TABLE_ID = parseInt(element.closest(self.class_list.TABLE).attr("table-id"));
    ...
    let page_table_detail = {
        ...
        set_page: function () {
            let self = this;
            self.variable_list.PAGE = new custom_pop_up(self.id_list.PAGE, "animate__slideInRight", "animate__slideOutLeft");
        },
        set_swiper: function() {
            let self = this;
            self.variable_list.SWIPER = new Swiper(self.id_list.SWIPER, {
                ...
                pagination: {
                    ...
                    renderBullet: function (index, className) {
                        ...
                        let firstDisabled = "";
                        switch (index) {
                            case 0: icon = "room-service"; break;
                            case 1: icon = "tag"; break;
                            case 2: icon = "food"; firstDisabled="disabled-element table-products-icon" ;break;
                            default:break;
                        }
        ...
        get_orders: function () {
            ...
            function create_element(){
                ...
                let orders = array_list.find_multi(main.data_list.ORDERS, self.variable_list.SELECTED_TABLE_ID, "table_id");
                ...
                orders.forEach(order => {
                    ...
                    order_products.forEach(order_product => {
                        ...
                        products_element += `
                            <div class="col-12 order-info-products pb-1 ${catering_class}" order-product-id="${order_product.id}">
                                <div class="row">
                                    ...
                                    <div class="col-1 p-0 pl-2 text-left">${order_product.qty}x</div>
                                    ...
                                    <div class="col-8 p-0 pr-1 text-right">
                                        <font class="float-left" id="order_product_${order_product.id}_info">${product.name}</font>${price.toFixed(2) + main.data_list.CURRENCY}
                                    </div>
                                </div>
                            </div>
                        `;
                    ...
                    element += `
                        <div class="e_order col-12 order" order-id="${order.id}">
                            <div class="row" id="order_${order.id}" data-toggle="collapse" data-target="#order_${order.id}_values" aria-expanded="true" aria-controls="order_${order.id}_values">
                                <div class="col-3 pl-1 pr-0" id="order_id_${order.id}_info">No: ${order.id}</div>
                                <div class="col-3 pl-1 pr-0">${((payed_total > 0) ? `<small><del class="mr-2">${total.toFixed(2)}</del></small>` : ``)}${(total - payed_total).toFixed(2) + main.data_list.CURRENCY}</span></div>
                                <div class="col-2 pl-1 pr-0">
                                    <button class="e_table_page_order_btn btn btn-danger btn-sm w-100 table-page-order-btn" function="print"><i class="fa fa-print"></i> ${language.data.PRINT}</button>
                                </div>
                                <div class="col-2 pl-1 pr-1">
                                    <button class="e_table_page_order_btn btn btn-success btn-sm w-100 table-page-order-btn" function="move"><i class="fa fa-arrow-left"></i> ${language.data.MOVE}</button>
                                </div>
                                <div class="col-2 pl-1 pr-1">
                                    <button class="e_add_new_order btn btn-primary btn-sm w-100 add_new_order" function="stated"><i class="mdi mdi-plus"></i>${language.data.ADD}</button>
                                </div>
                            </div>
                            <div id="order_${order.id}_values" class="collapse row mt-2 order-info" aria-labelledby="order_${order.id}" data-parent='#orders'>${products_element}</div>
                        </div>
                    `;
                });
        ...
        get_order_product_options: function () {
            ...
            let order_product = array_list.find(main.data_list.ORDER_PRODUCTS, self.variable_list.SELECTED_PRODUCT_ID, "id");
                    ...
                    element += `
                        <div class="col-12 basket-item">
                            <div class="basket-item">
                                <font class="float-left mr-2">[${option.name}]-> ${order_product_option.qty}x ${option_item.name}</font> ${(order_product_option.price != 0) ? `[${((order_product_option.price > 0) ? `+` : ``)}${(order_product_option.price) + main.data_list.CURRENCY}]` : ``}
                            </div>
                        </div>
                    `;
                });
        ...
        get_product_categories: function () {
            ...
            function create_element(){
                ...
                main.data_list.PRODUCT_CATEGORIES.forEach(product_category => {
                    if(self.variable_list.SEARCH_CATEGORY.length > 0 && !String(product_category.name.toLocaleLowerCase("tr")).match(new RegExp(self.variable_list.SEARCH_CATEGORY.toLocaleLowerCase("tr"), "gi"))) return;
                    if(typeof array_list.find(main.data_list.PRODUCTS, product_category.id, "category_id") === "undefined") return;
                    element += `
        ...
        get_products: function () {
            ...
            function create_element(){
                ...
                let products = (self.variable_list.SEARCH_PRODUCT.length > 0)
                    ...
                    : (self.variable_list.SELECTED_PRODUCT_CATEGORY_ID === 0)
                        ...
                        : array_list.find_multi(main.data_list.PRODUCTS, self.variable_list.SELECTED_PRODUCT_CATEGORY_ID, "category_id");

                products.forEach(product => {
                    if(product.is_delete == 1) return;
                    if(self.variable_list.SEARCH_PRODUCT.length > 0 && !String(product.name.toLocaleLowerCase("tr")).match(new RegExp(self.variable_list.SEARCH_PRODUCT.toLocaleLowerCase("tr"), "gi"))) return;
                    element += `
            ...
            function create_element(){
                ...
                linked_options.forEach(linked_option => {
                    ...
                    options.forEach(option => {
                        ...
                        element += `
                            <div class="option col-12 mt-3" option-type="${option.type}" option-limit="${linked_option.max_count}" option-id="${option.id}">
                        ...
                        option_items.forEach(option_item => {
                            element += `
                                <button type="button" class="btn btn-outline-primary ${(option_item.is_default == 1) ? `selected` : ``} mt-2 col-md-4" item-id="${option_item.id}" price="${option_item.price}">${option_item.name} ${(option_item.price != 0) ? `[` + ((option_item.price > 0) ? `+` : ``) + `${option_item.price + main.data_list.CURRENCY}]` : `` }</button>
                            `;
                        });
        ...
        get: function () {
            ...
            let table = array_list.find(main.data_list.TABLES, self.variable_list.SELECTED_TABLE_ID, "id");
            let section = array_list.find(main.data_list.SECTIONS, table.section_id, "id");
            let section_type = array_list.find(main.data_list.SECTION_TYPES, section.section_id, "id");
        ...
        initialize: function () {
            ...
            function set_events(){
                ...
                $(document).on("click", self.class_list.BUTTON_PRODUCT_CATEGORY, function () {
                    self.variable_list.SELECTED_PRODUCT_CATEGORY_ID = parseInt($(this).closest(`[category-id]`).attr("category-id"));
                    $(self.class_list.BOTTOM_ICONS).removeClass("disabled-element");
                    self.get_products();
                    self.variable_list.SWIPER.slideNext(250, true);
                });
                ...
                $(document).on("click", self.class_list.BUTTON_PRODUCT_PIECE, function () {
                    ...
                    let piece = 0;
                    switch (function_name) {
                        case "plus": piece = 1; break;
                        case "minus": piece = -1; break;
                    }
                ...
                $(document).on("click", self.class_list.BUTTON_PAGE, function(){
                    ...
                    switch(function_name){
                        case "back": self.close(); break;
                        case "show": page_basket.open(); break;
                    }
                });
                ...
                $(document).on("click", self.class_list.BUTTON_ORDER, function(e){
                    ...
                    self.variable_list.SELECTED_ORDER_ID = parseInt($(this).closest(`[order-id]`).attr("order-id"));

                    switch(function_name){
                        case "print":
                            print_invoice();
                            break;
                        case "move": page_move_table.get(); break;
                    }
                ...
                $(document).on("click", self.class_list.BUTTON_ORDER_PRODUCT, function(e){
                    ...
                    self.variable_list.SELECTED_PRODUCT_ID = parseInt($(this).closest(`[order-product-id]`).attr("order-product-id"));
    ...
    let page_move_table = {
        ...
        set_page: function () {
            let self = this;
            self.variable_list.PAGE = new custom_pop_up(self.id_list.PAGE, "animate__slideInUp", "animate__slideOutDown");
        },
        close: function () {
            let self = this;
        ...
        get: function () {
            ...
            function create_element() {
                ...
                let tables = (page_main.variable_list.SELECTED_SECTION_ID > 0)
                    ? array_list.find_multi(main.data_list.TABLES, page_main.variable_list.SELECTED_SECTION_ID, "section_id")
                ...
                tables.forEach(table => {
                    ...
                    element += `
                        <div class="e_table col-12 mt-1 p-3 ${table_status} border-bottom" table-id="${table.id}">
                            <div class="row">
        ...
        initialize: function () {
            ...
            function set_events(){
                ...
                $(document).on("click", self.class_list.BUTTON_TABLE, function () {
                    ...
                    let table_old = array_list.find(main.data_list.TABLES, page_table_detail.variable_list.SELECTED_TABLE_ID, "id");
                    let section_type_old = array_list.find(
                        main.data_list.SECTION_TYPES,
                        array_list.find(
                            main.data_list.SECTIONS,
                            table_old.section_id,
                            "id"
                        ).section_id,
                        "id"
                    );
                        ...
                        if (result.value) {
                            set_pos(
                                set_types.TABLE_MOVE,
                                {
                                    ...
                                    "order_id": (page_table_detail.variable_list.SELECTED_ORDER_ID > 0) ? page_table_detail.variable_list.SELECTED_ORDER_ID : 0
                                },
                                function (data){
                                    data = JSON.parse(data);
                                    if(data.status){
                                        main.get_order_related_things(main.get_type_for_order_related_things.ORDER_AND_ORDER_PRODUCTS);
                                        helper_sweet_alert.success(language.data.PROCESS_SUCCESS_TITLE, language.data.TABLE_MOVED);
                                        self.close();
                                        page_main.get_tables();
    ...
    let page_basket = {
        ...
        get_order_product_qty: function () {
                ...
                return `
                    <div class="container text-dark">
                        <div class="row">
                            ...
                            <div class="col-4 table-basket-product-piece text-center" id="basket_product_piece">${self.variable_list.DATA[self.variable_list.SELECTED_ORDER_PRODUCT_INDEX].qty}</div>
            ...
            $.confirm({
                title: array_list.find(main.data_list.PRODUCTS, self.variable_list.DATA[self.variable_list.SELECTED_ORDER_PRODUCT_INDEX].id, "id").name,
                backgroundDismiss: false,
                content: create_element(),
                type: 'red',
                typeAnimated: true,
                ...
                order_product_options.forEach((order_product_option, index) => {
                    ...
                    element += `
                        <div class="col-12 mb-2 basket-item" option-index="${index}">
                            <div class="row">
                                <div class="col-2 p-0 pl-1 text-left">
                                    <button class="e_basket_page_order_product_option_btn btn btn-danger basket-page-order-product-option-btn" function="delete">${language.data.DELETE}</button>
                                </div>
                                <div class="col-7 p-0 pr-1 text-left">
                                    <div class="basket-item">
                                        <font><small>[${option.name}]-></small> ${order_product_option.qty}x ${option_item.name}</font>  
                                        ${(order_product_option.price != 0) ? `[${((order_product_option.price > 0) ? `+` : ``)}${(order_product_option.price) + main.data_list.CURRENCY}]` : ``}
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        get: function (){
            ...
            function create_element() {
                ...
                self.variable_list.DATA.forEach((item, index) => {
                    let option_icon = (item.options.length < 1 && item.comment.length < 1 && item.quantity == 1) ? "hidden-and-events-none" : "";
                    total += item.price;
                        ...
                        <div class="col-12 mb-2 basket-item" index="${index}">
                            <div class="row">
                                <div class="col-1 p-0 pl-1 text-left">
                                    <button class="e_basket_page_order_product_btn btn btn-danger btn-sm basket-page-order-product-btn" function="delete">${language.data.DELETE}</button>
                                </div>
                                <div class="e_basket_page_order_product_btn col-1 p-0 pl-2 text-left basket-page-order-product-btn" function="show_count">${item.qty}x</div>
                                ...
                                <div class="col-9 p-0 pr-1 text-right">
                                    <div class="basket-item">
                                        <font class="float-left">${product.name}</font> ${item.price.toFixed(2) + main.data_list.CURRENCY}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            if(self.variable_list.DATA.length > 0)
                $(self.class_list.CONFIRM).show();
            else
                $(self.class_list.CONFIRM).hide();
        },
        initialize: function () {
            let self = this;
            ...
            function set_events(){
                ...
                $(document).on("click", self.class_list.BUTTON_ORDER_PRODUCT, function () {
                    ...
                    self.variable_list.SELECTED_ORDER_PRODUCT_INDEX = parseInt($(this).closest(`[index]`).attr("index"));
                    ...
                    switch(function_name){
                        case "delete":
                            ...
                            self.get();
                            break;
                        case "show_count": self.get_order_product_qty(); break;
                        case "show_options": self.get_order_product_options(); break;
                    }
                });
                ...
                $(document).on("click", self.class_list.BUTTON_ORDER_PRODUCT_QTY, function () {
                    ...
                    if(item.qty != product_piece){
                        ...
                        price *= product_piece;
                        self.variable_list.DATA[self.variable_list.SELECTED_ORDER_PRODUCT_INDEX].qty = product_piece;
                ...
                $(document).on("click", self.class_list.BUTTON_ORDER_PRODUCT_OPTION, function () {
                    ...
                    switch (function_name) {
                        case "delete":
                            console.log(self.variable_list.DATA[self.variable_list.SELECTED_ORDER_PRODUCT_INDEX].options[index]);
                            self.variable_list.DATA[self.variable_list.SELECTED_ORDER_PRODUCT_INDEX].price -= self.variable_list.DATA[self.variable_list.SELECTED_ORDER_PRODUCT_INDEX].options[index].price;
                            self.variable_list.DATA[self.variable_list.SELECTED_ORDER_PRODUCT_INDEX].options.splice(index, 1);
