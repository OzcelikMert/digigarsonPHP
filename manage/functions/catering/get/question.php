...
use config\table_helper\catering_questions as tbl;
...
class question {
    ...
    private function get(db $db, sessions $sessions) : array{
        return orders::get_catering_questions($db, $sessions->get->BRANCH_ID, order_by: $db->order_by(tbl::ID, $db::DESC))->rows;
    }
}