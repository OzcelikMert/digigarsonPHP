...
class server {
    ...
    public function from_this() : bool{
        $value = true;
     ...
     * @return bool
     */
    public static function create_path(string $path): bool {
     ...
     * @return bool
     */
    public static function write_to_file(string $file_location, string $text) : bool{
        $value = false;
     ...
     * @return array
     */
    public static function get_url_folders() : array {
