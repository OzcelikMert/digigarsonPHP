...
class product extends creator{
    ...
    protected function custom_links(): string{
        return '<link rel="stylesheet" href="assets/styles/product.css'.$this->v.'"';
    }

    protected function custom_scripts(): string{
        return '<script src="./assets/scripts/product.js'.$this->v.'"></script>';
    }
